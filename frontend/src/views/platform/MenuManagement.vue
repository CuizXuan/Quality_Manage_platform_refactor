...
.menu-management-page__header::after {
  position: absolute;
  inset: 0;
  pointer-events: none;
  background:
...
.menu-management-page__filters::before {
  position: absolute;
  inset: 0;
  pointer-events: none;
  background:
...
html:not(.dark) .menu-management-page__filters::before {
  background:
...
.menu-management-page__table::before {
  position: absolute;
  inset: 0;
  pointer-events: none;
  background:
...
html:not(.dark) .menu-management-page__table::before {
  background:
    linear-gradient(110deg, transparent 0 36%, rgba(22, 119, 255, 0.08) 50%, transparent 66%),
    radial-gradient(circle at 88% 16%, rgba(22, 119, 255, 0.1), transparent 26%);
}
...
html:not(.dark) .menu-management-page__table :deep(.el-table) {
...
html:not(.dark) .menu-management-page__pagination {
