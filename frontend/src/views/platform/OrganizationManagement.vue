...
.organization-management::before {
  position: absolute;
  inset: 0;
  pointer-events: none;
  background:
...
.organization-management__header::after {
  position: absolute;
  inset: 0;
  pointer-events: none;
  background:
...
.organization-management__filters::before {
  position: absolute;
  inset: 0;
  pointer-events: none;
  background:
...
html:not(.dark) .organization-management__filters::before {
  background:
...
.organization-management__table::before {
  position: absolute;
  inset: 0;
  pointer-events: none;
  background:
...
html:not(.dark) .organization-management__table::before {
  background:
    linear-gradient(110deg, transparent 0 36%, rgba(22, 119, 255, 0.08) 50%, transparent 66%),
    radial-gradient(circle at 88% 16%, rgba(22, 119, 255, 0.1), transparent 26%);
}
...
html:not(.dark) .organization-management__table :deep(.el-table) {
...
html:not(.dark) .organization-management__table :deep(.el-table__row:hover > td) {
...
html:not(.dark) .organization-management__pagination {
